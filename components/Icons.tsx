...
export const PomodoroIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2Z"></path><path d="M12 12 8 22"></path><path d="m16 22-4-10"></path><path d="M12 12 22 8"></path><path d="m22 16-10-4"></path><path d="M12 12 2 16"></path><path d="m2 8 10 4"></path><path d="m18 6-4 4"></path><path d="m6 18 4-4"></path></svg>
);

export const ReportIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8 6h8"></path><path d="M6 10h12"></path><path d="M6 14h12"></path><path d="M6 18h12"></path><rect width="20" height="20" x="2" y="2" rx="2"></rect></svg>
);

export const TaskIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.5 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.5L15.5 3Z"></path><path d="M15 3v6h6"></path><path d="m8 14 2 2 4-4"></path></svg>
);
...
export const TimeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 13V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8"></path><path d="M22 19a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"></path><path d="M19 16v3h2"></path><path d="M3 10h18"></path></svg>
);

export const TopCategoryIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 6.522c1.37-1.378 3.59-1.378 4.96 0 .93.93 1.3 2.14 1.3 3.278s-.37 2.348-1.3 3.278c-1.37 1.378-3.59 1.378-4.96 0l-2.02-2.022-2.02 2.022c-1.37 1.378-3.59 1.378-4.96 0-.93-.93-1.3-2.14-1.3-3.278s.37-2.348 1.3-3.278c1.37-1.378 3.59-1.378 4.96 0l2.02 2.022L12 6.522Z"></path></svg>
);
